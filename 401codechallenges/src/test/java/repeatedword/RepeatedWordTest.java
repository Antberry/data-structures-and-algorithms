...
public class RepeatedWordTest {
    ...
    public void stringOneTest(){
        ...
        assertEquals("a", repeatedWord.repeatedWord(test));
    ...
    public void stringTwoTest(){
        ...
        assertEquals("it", repeatedWord.repeatedWord(test));

    }
    @Test
    public void stringThreeTest(){
        RepeatedWord repeatedWord = new RepeatedWord();
        String test = "It were a queer, sultry summer , the summer they electrocuted the Rosenbergs, and I didn’t know what I was doing in New York...";

        assertEquals("summer", repeatedWord.repeatedWord(test));
